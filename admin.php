...
if(isset($_POST['add_product'])){
   ...
   //check it uploaded succefully or not
   if($insert_query){
...
if(isset($_GET['delete'])){
   ...
   //gives locations after click delete
   if($delete_query){
...
if(isset($_POST['update_product'])){
   ...
   //update to the selected query
   $update_query = mysqli_query($conn, "UPDATE `products` SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE productID = '$update_p_id'");
...
<head>
    ...
    <title>My Clinic.lk Admin</title>
...
<button class="back-btn"><a href="adminpage.php">← Back to admin page</a></button>
...
<section class="edit-form-container">
   ...
   <?php
          ...
          // If edit button is clicked, fetch the product details to edit
